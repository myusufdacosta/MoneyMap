    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-semibold text-gray-900">MoneyMap</h1>
          <p className="text-sm text-gray-500 mt-1">Track your money, beat your debt</p>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6">
          ...
          <button
            onClick={submit}
            disabled={loading}
            className="w-full bg-gray-900 text-white rounded-xl py-3 text-sm font-medium mt-4 disabled:opacity-50"
          >
